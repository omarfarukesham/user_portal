...
import { useAddPermission } from '@/services/permissions/usePermissions';
import { useGetPortals } from '@/services/portals/usePortals';
import { useNavigate } from 'react-router-dom';
import { toast } from 'react-toastify';

const PermissionAddForm = () => {
  const { isLoading, mutate } = useAddPermission();
  ...
  return (
    <PageInnerContainer className='h-full flex flex-col'>
      <Form
